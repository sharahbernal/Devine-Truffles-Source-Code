...
function openNav() {
  ...
  document.getElementById("Navbar").style.backgroundColor = "#cfcfcf";
...
function sendEmail() {
  ...
  Email.send({
    Host: "smtp.gmail.com",
    Username: "cainamargie.freelance@gmail.com",
    Password: "ilovemrbeast",
    To: 'cainamargie.freelance@gmail.com',
    From: email,
    Subject: subject,
    Body: message,
    Attachments: [
